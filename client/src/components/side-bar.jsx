...
export const Sidebar = ({ sideBarOpen, onSidebarClose }) => {
  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <MenuItems onSidebarClose={onSidebarClose} />

        <Link
          to={ROUTES.FEED.CREATE}
          className=" flex items-center justify-center gap-2 py-2.5 mt-6 mx-6 
                rounded-lg bg-gradient-to-r from-indigo-500 to-purple-600 hover:to-indigo-700 
      ...
      <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between">
        ...
        <LogOut className="w-4.5 text-gray-400 hover:text-gray-400 transition cursor-pointer" />
      </div>
    </div>
  );
};
